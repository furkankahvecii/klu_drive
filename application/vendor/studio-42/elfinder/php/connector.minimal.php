...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => 'C:\xampp\htdocs\codeigniter-elfinder',                 // path to files (REQUIRED)
			'URL'           => 'http://localhost/codeigniter-elfinder/', // URL to files (REQUIRED)
			'trashHash'     => 't1_Lw',                     // elFinder's hash of trash folder
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
			'uploadDeny'    => array('all'),                // All Mimetypes not allowed to upload
			'uploadAllow'   => array('image/x-ms-bmp', 'image/gif', 'image/jpeg', 'image/png', 'image/x-icon', 'text/plain', 'text/x-php'), // Mimetype `image` and `text/plain` allowed to upload
